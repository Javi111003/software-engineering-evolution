...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{images/timeline-preview.png}
    \caption{Línea de tiempo de la evolución de la Ingeniería de Software}
    \label{fig:evolucion}
\end{figure}

\noindent\textbf{Versión interactiva:} \\
La versión interactiva de la línea de tiempo se encuentra disponible en línea, permitiendo una exploración dinámica de las distintas etapas históricas de la ingeniería de software.
\href{https://javi111003.github.io/software-engineering-evolution/resources/timelinev2.html}{Abrir línea de tiempo interactiva}